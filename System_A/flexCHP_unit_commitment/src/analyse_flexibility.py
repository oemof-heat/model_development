...
# plt.show()
plt.savefig('scatter_plot_TES_charge_influence.png', dpi=300)
...
# plt.show()
plt.savefig('scatter_plot_TES_discharge_influence.png', dpi=300)
...
# plt.show()
plt.savefig('scatter_plot_EES_charge_influence.png', dpi=300)
...
# plt.show()
plt.savefig('scatter_plot_EES_discharge_influence.png', dpi=300)