...
filename_param = 'parameter_invest.csv'
...
storage_th = solph.components.GenericStorage(
    # nominal_capacity=param_value['nom_capacity_storage_th'],  # [MWh_th]
    label='storage_th',
...
storage_el = solph.components.GenericStorage(
    # nominal_capacity=param_value['nom_capacity_storage_el'],  # [MWh_el]
    label='storage_el',
