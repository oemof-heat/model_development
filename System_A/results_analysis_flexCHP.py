...
def show_results(make_plots=True,
                 use_ggplot=True,
                 show_plots=True, 
                 save_plots=True, 
                 print_slices=True,
...
#    logging.info('Restore the energy system and the results.')
    ...
    if make_plots==True:
        ...
        end = pd.to_datetime('15.02.2030 00:00:00', format='%d.%m.%Y %H:%M:%S')
        start_axes = pd.to_datetime('01.01.2030 00:00:00', format='%d.%m.%Y %H:%M:%S')
        end_axes = pd.to_datetime('15.02.2030 00:00:00', format='%d.%m.%Y %H:%M:%S')
