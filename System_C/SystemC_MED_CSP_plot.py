...
Speicher_bus = outputlib.views.node(energysystem.results['main'], 'None')
...
Speicher_seq = Speicher_bus['sequences']
...
print('max thermal from solar')
print(max(thermalh_seq[(('solar', 'thermal_high'), 'flow')]))
print('max thermal to PB')
print(max(thermalh_seq[(('thermal_high', 'PB'), 'flow')]))
print('max thermal low from PB')
print(max(thermall_seq[(('PB', 'thermal_low'), 'flow')]))
print('max thermal from TT')
print(max(thermall_seq[(('TT', 'thermal_low'), 'flow')]))
print("Kapazität Speicher thh")
print(max(Speicher_seq[(('storage_thh', 'None'), 'capacity')]))
print("Kapazität Speicher el")
print(max(Speicher_seq[(('storageel', 'None'), 'capacity')]))
print("Kapazität Speicher wat")
print(max(Speicher_seq[(('storagewat', 'None'), 'capacity')]))

### Write results in csv ###
#
#thermalh_seq.to_csv('data_output/MED_CSP_results_thh_250418.csv')
#Speicher_seq.to_csv('data_output/MED_CSP_results_speicher_8760_250418.csv')